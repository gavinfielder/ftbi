...
#    Updated: 2019/03/17 20:26:07 by gfielder         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC=src/ftbi_cond_1.c src/ftbi_cond_2.c src/ftbi_del.c src/ftbi_del.c \
	...
	src/ftbi_div_backend.c src/ftbi_div.c src/ftbi_pow.c src/ftbi_tostr.c \
...
OBJ:=$(shell echo $(SRC) | sed "s/\.c/\.o/g" | sed "s/src\//bin\//g" | sed "s/ftbf\//bin\//g")
